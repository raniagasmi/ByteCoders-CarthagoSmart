 ...
 */
final class Version20240330164328 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE avis (terrain_id INT NOT NULL, idAvis INT AUTO_INCREMENT NOT NULL, commentaire VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, note INT NOT NULL, INDEX fk_avis_terrain (terrain_id), PRIMARY KEY(idAvis)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE membreparequipe (id INT AUTO_INCREMENT NOT NULL, idEquipe INT NOT NULL, idMembre INT NOT NULL, INDEX idEquipe (idEquipe), INDEX idMembre (idMembre), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE participation (id INT AUTO_INCREMENT NOT NULL, idmembre INT NOT NULL, idTournoi INT NOT NULL, Status TINYINT(1) NOT NULL, datec VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, NomEquipe VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, INDEX idTournoi (idTournoi), INDEX idequipe (idmembre), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE payment (idPayment INT AUTO_INCREMENT NOT NULL, idMembre INT DEFAULT NULL, idReservation INT DEFAULT NULL, datePayment VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, horairePayment VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, Payed TINYINT(1) DEFAULT NULL, INDEX idReservation (idReservation), INDEX fk_payment_membre (idMembre), PRIMARY KEY(idPayment)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, idfournisseur INT NOT NULL, categorie INT DEFAULT NULL, nom VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_general_ci`, description TEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, prix NUMERIC(10, 2) DEFAULT \'NULL\', image VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_general_ci`, INDEX product_ibfk_1 (categorie), INDEX product_ibfk_3 (idfournisseur), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
