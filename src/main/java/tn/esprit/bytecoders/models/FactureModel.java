package tn.esprit.bytecoders.models;
...
public class FactureModel {
 ...
 public FactureModel(int id_facture, String libelle_facture, String date_facture, String date_ech_facture, double montant_facture, String type_facture, boolean payee){
