...
//    private Status etatUser;
    ...
    public User(int id, int cin, String nom, String prenom, String username, int numTlfn, String addEmail, String mdp, String urlImage, Roles roleUser, String confirmationCode, Boolean isVerified, boolean status) {
        this.id = id;
        this.cin = cin;
        this.nom = nom;
        this.prenom = prenom;
    ...
    public User(int cin, String nom, String prenom, String username, int numTlfn, String addEmail, String mdp, String urlImage, Roles roleUser, String confirmationCode, Boolean isVerified, boolean status) {
        this.cin = cin;
        this.nom = nom;
        this.prenom = prenom;
        this.username = username;
